...
- **Wazuh 安全平台** (4.7.4) - SIEM 安全監控
- **AI 代理** - AgenticRAG 智慧警報分析服務
...
| 服務              | URL                       | 預設認證                 |
|-------------------|---------------------------|--------------------------|
| 🔐 Wazuh 儀表板   | https://localhost:443     | admin / SecretPassword   |
| 🧠 AI 代理指標    | http://localhost:8000/metrics | -                        |
| 📊 Neo4j 瀏覽器   | http://localhost:7474     | neo4j / wazuh-graph-2024 |
...
# 手動驗證各服務
curl -f http://localhost:8000/health  # AI 代理
...
本部署指南提供了 Wazuh GraphRAG 系統的完整部署流程，從環境準備到服務驗證，涵蓋了所有必要的步驟和配置。透過遵循本指南，您可以成功部署一個功能完整的智慧安全營運系統。
